...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-24 md:pt-32 lg:pt-20 overflow-hidden overflow-x-hidden bg-[#F9FAFB]">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-20 items-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="text-center lg:text-left">
            <div className="inline-flex items-center gap-1.5 md:gap-2 px-3 md:px-5 py-1.5 md:py-2.5 rounded-full bg-primary/10 border border-primary/20 mb-4 md:mb-6">
              <Shield className="w-3.5 h-3.5 md:w-4 md:h-4 text-primary" />
              <span className="text-xs md:text-sm font-semibold text-primary tracking-wide">Le réseau d'artisans audités sur le terrain</span>
            </div>
            ...
            <div className="space-y-3 mb-6 md:mb-8 max-w-xl mx-auto lg:mx-0">
              <div className="flex items-start gap-2.5">
                ...
                <p className="text-sm md:text-base text-muted-foreground leading-snug">
                  <span className="text-foreground font-semibold">Particuliers :</span> Trouvez l'artisan audité sur le terrain qui réalisera vos travaux en toute sérénité.
                </p>
              </div>
              <div className="flex items-start gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-gold mt-0.5 shrink-0" />
                <p className="text-sm md:text-base text-muted-foreground leading-snug">
                  <span className="text-foreground font-semibold">Artisans :</span> Reprenez le contrôle de votre activité. Intégrez un réseau d'élite sans intermédiaire ni commission sur vos devis.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 md:gap-4 mb-4 md:mb-6 relative z-50">
              ...
              <div className="text-center sm:text-left">
                ...
                <p className="text-[10px] text-muted-foreground/60 mt-1.5 italic">⚠️ Places limitées par département pour garantir la qualité.</p>
              </div>
            </div>

            <p className="text-sm text-muted-foreground mb-3 md:mb-4 leading-snug">
            ...
            <p className="text-xs text-muted-foreground/60 mb-8 md:mb-10 leading-snug italic">
              Le seul réseau national qui protège vos données : zéro harcèlement, juste l'excellence.
            </p>

            <div className="bg-white/80 backdrop-blur-sm rounded-xl md:rounded-2xl p-4 md:p-5 border border-border shadow-sm">
              <div className="grid grid-cols-3 gap-3 md:gap-6">
                {[
                  ...
                  <div key={i} className="text-center">
                    <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-gold/15 flex items-center justify-center mx-auto mb-2">
                      <step.icon className="w-5 h-5 md:w-6 md:h-6 text-gold" />
                    </div>
                    <p className="text-xs md:text-sm text-muted-foreground leading-tight">{step.label}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl shadow-lg p-8 border border-border">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-foreground">Andrea : Ton Assistante de Choc</h3>
                </div>
                ...
                <div className="grid grid-cols-3 gap-3 mb-6">
                  {[
                    ...
                    <div key={label} className="text-center p-3 rounded-lg bg-muted border border-border">
              ...
              <motion.div animate={{ y: [0, -10, 0] }} transition={{ duration: 3, repeat: Infinity }} className="absolute -top-4 -right-4 bg-white rounded-xl shadow-lg p-3 border border-border">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-full bg-gold/10 flex items-center justify-center">
                    <Shield className="w-4 h-4 text-gold" />
                  </div>
                  <div>
                    <div className="text-sm font-medium text-foreground">IA de confiance</div>
