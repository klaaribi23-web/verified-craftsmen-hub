...
const PowerBlock = () => {
  ...
  return (
    <section className="relative bg-background pt-28 md:pt-36 pb-24 md:pb-[120px] overflow-hidden">
      {/* Ambient glow */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="flex flex-col sm:flex-row items-stretch bg-card border border-border rounded-xl sm:rounded-full overflow-hidden backdrop-blur-sm">
            {/* Métier */}
            <div className="flex items-center flex-1 px-5 py-3.5 gap-3 border-b sm:border-b-0 sm:border-r border-border">
              ...
              <input
                ...
                className="bg-transparent w-full text-foreground placeholder:text-muted-foreground text-sm md:text-base outline-none"
              />
            </div>
            {/* Ville */}
            <div className="flex items-center flex-1 px-5 py-3.5 gap-3 border-b sm:border-b-0 sm:border-r border-border">
        ...
        >
          ...
          <p className="text-center text-sm md:text-base text-foreground/90 font-medium tracking-wide">
            Accès direct aux{' '}
        ...
        >
          {[
            ...
            <div
              key={label}
              className="relative flex items-center gap-2 px-3 py-2 rounded-full bg-card border border-primary/20 backdrop-blur-[4px] overflow-hidden transition-transform duration-200 hover:scale-105 cursor-default"
            >
              ...
              <span className="relative text-foreground font-semibold text-[10px] md:text-xs tracking-[0.12em] uppercase whitespace-nowrap">
                {label}
              </span>
            </div>
          ))}
