...
const AnimatedIcon = ({ icon: Icon, color, index }: { icon: any; color: string; index: number }) => {
  return (
    <motion.div
      className={`relative w-20 h-20 rounded-2xl bg-gradient-to-br ${color} flex items-center justify-center shadow-lg`}
  ...
  return (
    <section className="py-20 lg:py-32 bg-muted relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <motion.div
          className="absolute -bottom-40 -left-40 w-80 h-80 rounded-full bg-navy/5 blur-3xl"
          animate={{ 
            scale: [1.2, 1, 1.2],
            opacity: [0.3, 0.5, 0.3]
          }}
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          <motion.span 
            className="inline-block px-4 py-1.5 rounded-full bg-gold/10 text-gold text-sm font-medium mb-4"
