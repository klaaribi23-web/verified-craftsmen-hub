...
const DEMO_MISSIONS = [
  // ── EXISTING 20 ──
  {
    id: "demo-1", title: "Rénovation énergétique appartement 65m²",
    ...
    city: "Lille (59)", budget: null, budget_range: "15 000€ – 50 000€", urgency: "1 à 3 mois",
  ...
  {
    id: "demo-2", title: "Peinture complète maison 120m²",
    ...
    city: "Tourcoing (59)", budget: null, budget_range: "5 000€ – 15 000€", urgency: "1 à 3 mois",
  ...
  {
    id: "demo-3", title: "Extension bois 25m² avec toit plat",
    ...
    city: "Roubaix (59)", budget: null, budget_range: "Plus de 50 000€", urgency: "Plus de 3 mois",
  ...
  {
    id: "demo-4", title: "Installation PAC air-eau + plancher chauffant",
    ...
    city: "Villeneuve-d'Ascq (59)", budget: null, budget_range: "15 000€ – 50 000€", urgency: "Immédiatement",
  ...
  {
    id: "demo-5", title: "Rénovation salle de bain complète 8m²",
    ...
    city: "Marcq-en-Barœul (59)", budget: null, budget_range: "5 000€ – 15 000€", urgency: "1 à 3 mois",
    created_at: new Date(Date.now() - 4 * 60 * 60 * 1000).toISOString(),
  ...
  {
    id: "demo-6", title: "Mise aux normes électriques NF C 15-100",
    ...
    city: "Lille (59)", budget: null, budget_range: "5 000€ – 15 000€", urgency: "Immédiatement",
  ...
  {
    id: "demo-7", title: "Ravalement façade immeuble R+3",
    ...
    city: "Lambersart (59)", budget: null, budget_range: "Plus de 50 000€", urgency: "Plus de 3 mois",
  ...
  {
    id: "demo-8", title: "Pose cuisine équipée + électroménager",
    ...
    city: "Wasquehal (59)", budget: null, budget_range: "5 000€ – 15 000€", urgency: "1 à 3 mois",
    created_at: new Date(Date.now() - 3 * 60 * 60 * 1000).toISOString(),
  ...
  {
    id: "demo-9", title: "Installation panneaux solaires 6kWc",
    ...
    city: "Croix (59)", budget: null, budget_range: "15 000€ – 50 000€", urgency: "1 à 3 mois",
    created_at: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
    category: { id: "c9", name: "Panneaux solaires" },
    client_name: "Client vérifié", applicants_count: 1, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  {
    id: "demo-10", title: "Isolation combles perdus 80m²",
    ...
    city: "Hem (59)", budget: null, budget_range: "3 000€ – 8 000€", urgency: "Immédiatement",
    created_at: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString(),
  ...
  {
    id: "demo-11", title: "Rénovation énergétique globale maison 150m²",
    ...
    city: "Ronchin (59)", budget: null, budget_range: "Plus de 50 000€", urgency: "1 à 3 mois",
    created_at: new Date(Date.now() - 3 * 60 * 60 * 1000).toISOString(),
    category: { id: "c1", name: "Rénovation Globale" },
  ...
  {
    id: "demo-12", title: "Remplacement chaudière gaz par PAC",
    ...
    city: "Loos (59)", budget: null, budget_range: "10 000€ – 20 000€", urgency: "Immédiatement",
    created_at: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString(),
    category: { id: "c4", name: "PAC" },
  ...
  {
    id: "demo-13", title: "Création terrasse composite 30m²",
    ...
    city: "Mons-en-Barœul (59)", budget: null, budget_range: "5 000€ – 12 000€", urgency: "Plus de 3 mois",
    created_at: new Date(Date.now() - 5 * 60 * 60 * 1000).toISOString(),
    category: { id: "c11", name: "Terrasse" },
    client_name: "Client vérifié", applicants_count: 0, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  {
    id: "demo-14", title: "Réfection toiture tuiles 100m²",
    ...
    city: "La Madeleine (59)", budget: null, budget_range: "15 000€ – 30 000€", urgency: "1 à 3 mois",
    created_at: new Date(Date.now() - 4 * 60 * 60 * 1000).toISOString(),
    category: { id: "c12", name: "Toiture" },
    client_name: "Client vérifié", applicants_count: 2, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  {
    id: "demo-15", title: "Plomberie complète appartement neuf",
    ...
    city: "Faches-Thumesnil (59)", budget: null, budget_range: "5 000€ – 10 000€", urgency: "1 à 3 mois",
    created_at: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
    category: { id: "c13", name: "Plomberie" },
    client_name: "Client vérifié", applicants_count: 3, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  {
    id: "demo-16", title: "Portail motorisé + clôture aluminium",
    ...
    city: "Wattignies (59)", budget: null, budget_range: "5 000€ – 15 000€", urgency: "1 à 3 mois",
    created_at: new Date(Date.now() - 3 * 60 * 60 * 1000).toISOString(),
    category: { id: "c14", name: "Menuiserie extérieure" },
    client_name: "Client vérifié", applicants_count: 0, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  {
    id: "demo-17", title: "Aménagement combles 40m² habitable",
    ...
    city: "Seclin (59)", budget: null, budget_range: "30 000€ – 60 000€", urgency: "Plus de 3 mois",
    created_at: new Date(Date.now() - 6 * 60 * 60 * 1000).toISOString(),
    category: { id: "c1", name: "Rénovation Globale" },
    client_name: "Client vérifié", applicants_count: 1, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  {
    id: "demo-18", title: "Dépannage urgent fuite toiture",
    ...
    city: "Armentières (59)", budget: null, budget_range: "1 000€ – 3 000€", urgency: "Immédiatement",
    created_at: new Date(Date.now() - 30 * 60 * 1000).toISOString(),
    category: { id: "c12", name: "Toiture" },
    client_name: "Client vérifié", applicants_count: 0, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  {
    id: "demo-19", title: "Carrelage sol + murs salon 45m²",
    ...
    city: "Haubourdin (59)", budget: null, budget_range: "4 000€ – 8 000€", urgency: "1 à 3 mois",
    created_at: new Date(Date.now() - 4 * 60 * 60 * 1000).toISOString(),
    category: { id: "c15", name: "Carrelage" },
    client_name: "Client vérifié", applicants_count: 2, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  {
    id: "demo-20", title: "Installation VMC double flux",
    ...
    city: "Halluin (59)", budget: null, budget_range: "4 000€ – 8 000€", urgency: "1 à 3 mois",
    created_at: new Date(Date.now() - 5 * 60 * 60 * 1000).toISOString(),
    category: { id: "c16", name: "Ventilation" },
    client_name: "Client vérifié", applicants_count: 0, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  // ── 20 NEW MISSIONS – Solaire, PAC, Menuiserie, Électricité, Rénovation globale ──
  // --- SOLAIRE / PV (4 missions) ---
  {
    id: "demo-21", title: "Installation solaire 9kWc + batterie de stockage",
    description: "Pose 20 panneaux photovoltaïques 450Wc sur toiture ardoise orientée sud-ouest. Batterie lithium 10kWh, onduleur hybride. Raccordement Enedis autoconsommation avec revente surplus. QualiPV RGE exigé.",
    city: "Arras (62)", budget: null, budget_range: "18 000€ – 25 000€", urgency: "1 à 3 mois",
    created_at: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString(),
    category: { id: "c9", name: "Panneaux solaires" },
    client_name: "Client vérifié", applicants_count: 2, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: true,
  },
  {
    id: "demo-22", title: "Centrale photovoltaïque 3kWc maison neuve",
    description: "Installation 8 panneaux PV monocristallins 375Wc sur maison RT2020. Micro-onduleurs Enphase. Monitoring application mobile. Déclaration préalable fournie.",
    city: "Lens (62)", budget: null, budget_range: "10 000€ – 14 000€", urgency: "Immédiatement",
    created_at: new Date(Date.now() - 35 * 60 * 1000).toISOString(),
    category: { id: "c9", name: "Panneaux solaires" },
    client_name: "Client vérifié", applicants_count: 0, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  {
    id: "demo-23", title: "Solaire autoconsommation 6kWc + borne de recharge",
    description: "Pose panneaux solaires 6kWc couplée à borne de recharge véhicule électrique 7kW. Gestion intelligente de l'énergie. Toiture tuiles mécaniques, accès facile.",
    city: "Douai (59)", budget: null, budget_range: "15 000€ – 22 000€", urgency: "1 à 3 mois",
    created_at: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
    category: { id: "c9", name: "Panneaux solaires" },
    client_name: "Client vérifié", applicants_count: 1, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: true,
  },
  {
    id: "demo-24", title: "Extension installation solaire existante +3kWc",
    description: "Ajout de 8 panneaux sur installation existante de 3kWc. Remplacement onduleur string par onduleur hybride. Mise à jour déclaration Enedis.",
    city: "Dunkerque (59)", budget: null, budget_range: "10 000€ – 15 000€", urgency: "Ce mois-ci",
    created_at: new Date(Date.now() - 3 * 60 * 60 * 1000).toISOString(),
    category: { id: "c9", name: "Panneaux solaires" },
    client_name: "Client vérifié", applicants_count: 0, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  // --- PAC (4 missions) ---
  {
    id: "demo-25", title: "PAC air-eau 14kW + ballon thermodynamique",
    description: "Remplacement chaudière fioul par PAC air-eau 14kW Atlantic. Ballon ECS thermodynamique 270L. Raccordement radiateurs basse température. Dossier MaPrimeRénov' Sérénité.",
    city: "Valenciennes (59)", budget: null, budget_range: "12 000€ – 15 000€", urgency: "Immédiatement",
    created_at: new Date(Date.now() - 40 * 60 * 1000).toISOString(),
    category: { id: "c4", name: "PAC" },
    client_name: "Client vérifié", applicants_count: 1, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: true,
  },
  {
    id: "demo-26", title: "PAC air-air gainable 4 pièces",
    description: "Installation PAC air-air gainable pour maison 110m². 4 bouches de diffusion. Groupe extérieur silencieux. Pilotage wifi. Artisan RGE QualiPAC.",
    city: "Arras (62)", budget: null, budget_range: "8 000€ – 12 000€", urgency: "1 à 3 mois",
    created_at: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
    category: { id: "c4", name: "PAC" },
    client_name: "Client vérifié", applicants_count: 3, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  {
    id: "demo-27", title: "Remplacement PAC vétuste + plancher chauffant",
    description: "Dépose PAC air-eau 10 ans hors service. Nouvelle PAC 10kW Daikin. Vérification et purge circuit plancher chauffant existant. Mise en service complète.",
    city: "Lens (62)", budget: null, budget_range: "10 000€ – 14 000€", urgency: "Immédiatement",
    created_at: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString(),
    category: { id: "c4", name: "PAC" },
    client_name: "Client vérifié", applicants_count: 0, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: true,
  ...
  {
    id: "demo-28", title: "PAC géothermique eau-eau forage",
    description: "Installation PAC géothermique 12kW avec forage 2x80m. Plancher chauffant-rafraîchissant. Projet éligible MaPrimeRénov' + CEE. Étude de sol réalisée.",
    city: "Tourcoing (59)", budget: null, budget_range: "15 000€ – 20 000€", urgency: "Plus de 3 mois",
    created_at: new Date(Date.now() - 4 * 60 * 60 * 1000).toISOString(),
    category: { id: "c4", name: "PAC" },
    client_name: "Client vérifié", applicants_count: 2, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  // --- MENUISERIE / FENÊTRES (4 missions) ---
  {
    id: "demo-29", title: "Remplacement 8 fenêtres PVC double vitrage",
    description: "Dépose anciennes fenêtres bois simple vitrage. Pose 8 fenêtres PVC blanc Uw ≤ 1.3 W/m²K. 2 baies vitrées coulissantes. Volets roulants motorisés. Artisan RGE.",
    city: "Roubaix (59)", budget: null, budget_range: "8 000€ – 12 000€", urgency: "1 à 3 mois",
    created_at: new Date(Date.now() - 50 * 60 * 1000).toISOString(),
    category: { id: "c14", name: "Menuiserie extérieure" },
    client_name: "Client vérifié", applicants_count: 4, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  {
    id: "demo-30", title: "Pose porte d'entrée blindée + volets battants",
    description: "Remplacement porte d'entrée par porte blindée A2P BP3. Pose 6 volets battants alu sur mesure. Coloris RAL au choix. Serrure 5 points.",
    city: "Dunkerque (59)", budget: null, budget_range: "5 000€ – 9 000€", urgency: "Immédiatement",
    created_at: new Date(Date.now() - 25 * 60 * 1000).toISOString(),
    category: { id: "c14", name: "Menuiserie extérieure" },
    client_name: "Client vérifié", applicants_count: 1, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  {
    id: "demo-31", title: "Menuiseries alu maison contemporaine 140m²",
    description: "Fourniture et pose complète menuiseries alu gris anthracite RAL 7016. 12 ouvrants + 2 baies 3m + 1 porte-fenêtre. Triple vitrage. Certification QualiBAT.",
    city: "Valenciennes (59)", budget: null, budget_range: "10 000€ – 15 000€", urgency: "1 à 3 mois",
    created_at: new Date(Date.now() - 3 * 60 * 60 * 1000).toISOString(),
    category: { id: "c14", name: "Menuiserie extérieure" },
    client_name: "Client vérifié", applicants_count: 0, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  {
    id: "demo-32", title: "Véranda aluminium 20m² toiture vitrée",
    description: "Construction véranda alu 20m² avec toiture vitrée feuilletée. Stores intégrés motorisés. Chauffage au sol prévu. Fondations et dalle incluses.",
    city: "Douai (59)", budget: null, budget_range: "12 000€ – 18 000€", urgency: "Plus de 3 mois",
    created_at: new Date(Date.now() - 5 * 60 * 60 * 1000).toISOString(),
    category: { id: "c14", name: "Menuiserie extérieure" },
    client_name: "Client vérifié", applicants_count: 1, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  // --- ÉLECTRICITÉ / MISE AUX NORMES (4 missions) ---
  {
    id: "demo-33", title: "Rénovation électrique complète maison 100m²",
    description: "Mise aux normes NF C 15-100 complète. Nouveau tableau 4 rangées, disjoncteur différentiel, terre aux normes. 45 points lumineux + prises. Passage consuel.",
    city: "Arras (62)", budget: null, budget_range: "5 000€ – 7 000€", urgency: "1 à 3 mois",
    created_at: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
    category: { id: "c6", name: "Électricité" },
    client_name: "Client vérifié", applicants_count: 2, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  {
    id: "demo-34", title: "Installation domotique + éclairage LED maison",
    description: "Passage en éclairage LED intégral (spots, bandeaux, appliques). Installation système domotique KNX : volets, chauffage, éclairage. Programmation scénarios.",
    city: "Lille (59)", budget: null, budget_range: "4 000€ – 7 000€", urgency: "Ce mois-ci",
    created_at: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString(),
    category: { id: "c6", name: "Électricité" },
    client_name: "Client vérifié", applicants_count: 0, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  {
    id: "demo-35", title: "Mise en sécurité électrique appartement ancien",
    description: "Appartement 1930, 70m². Remplacement tableau fusible, mise à la terre, protection différentielle. Reprise partielle câblage vétuste. Diagnostic avant-vente.",
    city: "Dunkerque (59)", budget: null, budget_range: "2 000€ – 4 000€", urgency: "Immédiatement",
    created_at: new Date(Date.now() - 20 * 60 * 1000).toISOString(),
    category: { id: "c6", name: "Électricité" },
    client_name: "Client vérifié", applicants_count: 5, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  {
    id: "demo-36", title: "Tableau électrique + borne recharge VE 22kW",
    description: "Remplacement tableau vétuste + installation borne de recharge véhicule électrique 22kW triphasé. Augmentation puissance compteur. IRVE qualifié.",
    city: "Valenciennes (59)", budget: null, budget_range: "3 000€ – 5 500€", urgency: "1 à 3 mois",
    created_at: new Date(Date.now() - 3 * 60 * 60 * 1000).toISOString(),
    category: { id: "c6", name: "Électricité" },
    client_name: "Client vérifié", applicants_count: 1, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  // --- RÉNOVATION GLOBALE (4 missions) ---
  {
    id: "demo-37", title: "Rénovation complète maison 1950 - 180m²",
    description: "Projet global : ITE 180m², menuiseries PVC 14 ouvrants, PAC air-eau 16kW, VMC double flux, isolation plancher bas. DPE F vers B. Budget MaPrimeRénov' Parcours Accompagné.",
    city: "Lens (62)", budget: null, budget_range: "60 000€ – 80 000€", urgency: "1 à 3 mois",
    created_at: new Date(Date.now() - 55 * 60 * 1000).toISOString(),
    category: { id: "c1", name: "Rénovation Globale" },
    client_name: "Client vérifié", applicants_count: 3, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: true,
  },
  {
    id: "demo-38", title: "Réhabilitation corps de ferme 250m²",
    description: "Transformation corps de ferme en habitation. Gros œuvre, charpente, couverture, menuiseries, plomberie, électricité, chauffage. Permis accordé. Architecte mandaté.",
    city: "Douai (59)", budget: null, budget_range: "Plus de 80 000€", urgency: "Plus de 3 mois",
    created_at: new Date(Date.now() - 4 * 60 * 60 * 1000).toISOString(),
    category: { id: "c1", name: "Rénovation Globale" },
    client_name: "Client vérifié", applicants_count: 1, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
  {
    id: "demo-39", title: "Rénovation appartement T4 85m² clé en main",
    description: "Rénovation intégrale : démolition cloisons, redistribution pièces, plomberie, électricité, sol, peinture. Cuisine et SDB neuves. Livraison clé en main souhaitée.",
    city: "Roubaix (59)", budget: null, budget_range: "35 000€ – 55 000€", urgency: "1 à 3 mois",
    created_at: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
    category: { id: "c1", name: "Rénovation Globale" },
    client_name: "Client vérifié", applicants_count: 0, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: true,
  },
  {
    id: "demo-40", title: "Surélévation maison + rénovation énergétique",
    description: "Surélévation R+1 ossature bois 60m². Isolation complète existant + extension. PAC, VMC, menuiseries neuves. Permis de construire obtenu. DPE visé : A.",
    city: "Tourcoing (59)", budget: null, budget_range: "70 000€ – 100 000€", urgency: "Plus de 3 mois",
    created_at: new Date(Date.now() - 3 * 60 * 60 * 1000).toISOString(),
    category: { id: "c1", name: "Rénovation Globale" },
    client_name: "Client vérifié", applicants_count: 2, has_applied: false, photos: null, status: "published", client_id: "", fake_applicants_count: 0, is_urgent: false,
  },
