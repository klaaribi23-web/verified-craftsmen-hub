    ...
    <>
      ...
      >
        ...
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(180deg, transparent 0%, hsl(var(--primary) / 0.08) 50%, transparent 100%)",
          }}
          animate={{ y: ["-100%", "100%"] }}
        ...
        >
          ...
          <h1 className="text-2xl md:text-3xl font-black text-foreground uppercase tracking-wide mb-3">
            ACCÈS EXCLUSIF
          </h1>
          ...
          <div className="flex items-center justify-center gap-1 my-6">
            ...
            <span className="text-xs text-muted-foreground uppercase tracking-wider mr-3">
            ...
            {[pad(countdown.h), pad(countdown.m), pad(countdown.s)].map(
              (unit, i) => (
                <span key={i} className="flex items-center">
                  <span
                    className="border border-primary/30 rounded-lg px-3 py-2 text-xl font-mono font-bold text-primary tabular-nums bg-muted"
                  >
                    {unit}
                  </span>
                  {i < 2 && (
          ...
          {/* Progress bar */}
          <div
            className="mt-8 w-full h-1 rounded-full overflow-hidden bg-primary/15"
          >
            <motion.div
