...
const APropos = () => {
  return (
    <>
      <SEOHead
        title="À Propos"
        description="Artisans Validés : là où la confiance reprend sa place. Découvrez notre vision d'un bâtiment plus respecté et d'une relation plus saine entre artisans et particuliers."
      ...
      <main className="min-h-screen">
        ...
        <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
          ...
          >
            ...
            <motion.p 
              variants={fadeInUp}
              className="text-xl md:text-2xl text-gold font-medium italic"
            >
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              >
                ...
                <motion.ul variants={fadeInUp} className="space-y-4 text-foreground">
                  {[
                    ...
                    "Coordonnées vendues à la chaîne",
                    "Appels incessants",
                    "Artisans mis en concurrence sans respect de leur métier",
                    "Particuliers déçus, méfiants, fatigués"
                  ].map((item, index) => (
                ...
                <motion.p 
                  variants={fadeInUp}
                  className="mt-10 text-2xl md:text-3xl font-bold text-primary"
                >
                  Nous avons dit stop.
                </motion.p>
              </motion.div>
              ...
              >
                ...
                <img 
                  src={homeTrust} 
                  alt="Intérieur de maison chaleureux" 
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="space-y-4">
                  {[
                    { icon: Heart, text: "La confiance avant la quantité" },
                    { icon: Star, text: "Le savoir-faire avant les promesses" },
                    { icon: Shield, text: "Le respect avant la pression" }
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              >
                <div className="relative">
                  ...
                  <img 
                    src={platformBrowse} 
                    alt="Navigation sur la plateforme" 
                    className="relative rounded-2xl shadow-2xl w-full"
                  />
                </div>
              </motion.div>
              ...
              >
                ...
                <motion.div variants={fadeInUp} className="space-y-4 mb-8">
                  {[
                    "Vous prenez le temps de choisir",
                    "Vous consultez des profils complets",
                    "Vous découvrez des réalisations concrètes",
                    "Vous lisez des avis transparents",
                    "Vous décidez librement qui contacter, et quand"
                  ].map((item, index) => (
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              >
                ...
                <motion.div 
                  variants={fadeInUp}
                  className="bg-gradient-to-r from-gold/10 to-primary/10 p-6 rounded-xl border border-gold/20"
                >
                ...
                <motion.p 
                  variants={fadeInUp}
                  className="mt-8 text-lg text-gold font-medium"
                >
              ...
              >
                <div className="relative">
                  ...
                  <img 
                    src={artisanPortrait} 
                    alt="Portrait d'un artisan professionnel" 
                    className="relative rounded-2xl shadow-2xl w-full"
                  />
                </div>
              </motion.div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              {[
                ...
                { title: "Pas de promesses floues", desc: "Clarté et transparence" },
            ...
            >
              ...
              <motion.div variants={fadeInUp} className="flex flex-wrap justify-center gap-4 mb-12">
                {["des projets sérieux", "des professionnels engagés", "une plateforme claire, transparente et humaine"].map((item, index) => (
                  <span key={index} className="px-4 py-2 bg-gold/20 text-gold rounded-full text-sm font-medium">
                    {item}
                  </span>
                ))}
              </motion.div>
        ...
        <section className="py-20 md:py-28 bg-background">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <motion.div 
                variants={fadeInUp}
                className="bg-gradient-to-r from-navy to-primary p-8 md:p-12 rounded-2xl text-white mb-12"
              >
